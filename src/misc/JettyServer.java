...
import misc.handler.MiscGetHandler;
...
import misc.handler.MiscPostHandler;
...
public class JettyServer extends AbstractHandler
{
        ...
        throws IOException, ServletException
    {
        ...
        try
        {
            ...
            if ( service.equals(Service.MISC) )
            {
                String urn = Utils.pop(target);
                if ( method.equals("GET") )
                    new MiscGetHandler().handle( request, response, urn );
                else if ( method.equals("POST") )
                    new MiscPostHandler().handle(request, response, urn );
                else
                    throw new MiscException("Unknown http method "+method);
            }
            else
                throw new MiscException("Unknown service "+service);
        }
        catch ( MiscException ce )
        {
